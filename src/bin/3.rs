...
fn main() {
    ...
    for line in input.lines() {
        ...
        let elems = set_n(first.chars(), second.chars());
        for elem in elems {
            if elem.is_ascii_lowercase() {
                count += (elem as i32 - 'a' as i32) + 1;
            } else {
                count += (elem as i32 - 'A' as i32) + 27;
            }
        }
    }
    ...
    for [a, b, c] in input.lines().array_chunks() {
        let elems = set_n(a.chars(), b.chars());
        let elems = set_n(elems, c.chars());
        for elem in elems {
            if elem.is_ascii_lowercase() {
                count += (elem as i32 - 'a' as i32) + 1;
            } else {
